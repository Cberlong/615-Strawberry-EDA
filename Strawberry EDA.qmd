---
title: "Stawberries EDA: Final draft"
author: MA615
date: 2023 Oct 23
format: html
engine: knitr
Output-dir: 615-Strawberry-EDA/
---
...
plot1_data <- strawberry |> 
  select(c(Year, State, 'Domain Category', Value)) |> 
  filter((Year == 2021) & ('Domain Category' == "ORGANIC - OPERATIONS WITH SALES"))
...
plot2_data <- strawberry |> 
  select(c(Year, State, 'Domain Category', 'Data Item', Value)) |> 
  filter((Year == 2021) & 
           ('Domain Category' == "ORGANIC - SALES") & 
           ('Data Item' == "MEASURED IN $") & 
           (Value != "(D)"))
